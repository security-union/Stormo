...
struct EndToEndSessionTests {
    ...
    func declinedInvitation() async throws {
        ...
        await #expect(throws: StormoError.invitationDeclined) {
    ...
    func invitationTimeout() async throws {
        ...
        await #expect(throws: StormoError.invitationTimedOut) {
    ...
    func datagramCap() async throws {
        ...
        await #expect(throws: StormoError.datagramTooLarge(
        ...
        await #expect(throws: StormoError.peerUnreachable(identity.id)) {
    ...
    func sendWithoutMembers() async throws {
        ...
        let session = PeerSession(
            ...
            service: "_e2e._udp",
            transport: InMemoryTransport(hub: hub))
        await #expect(throws: StormoError.self) {
    ...
    static func makeTempFile(bytes: Int) throws -> URL {
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("Stormo-src-\(UUID().uuidString).bin")
